            ...
            <table>
                <tr class="lwa-row">
                    ...
                    <td class="lwa-submit-button">
                        <input type="submit" name="wp-submit" id="lwa_wp-submit" class="button btn" value="<?php esc_attr_e('Log In', 'login-with-ajax'); ?>" tabindex="100" />
            ...
            <table>
                ...
                <tr>
                    <td class="lwa-remember-buttons">
                        <input type="submit" value="<?php esc_attr_e("Get New Password", 'login-with-ajax'); ?>" class="lwa-button-remember btn button" />
                        <a href="#" style="margin-left:1em;" class="lwa-links-remember-cancel"><?php esc_html_e("Cancel", 'login-with-ajax'); ?></a>
