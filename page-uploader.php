				...
				<div id="inner-content" class="wrap clearfix">
						...
						<div id="main" class="twelvecol first clearfix" role="main">
							...
							<article class="uploader">
								...
								<p class="intro2">Use the 'Add File...' button to select your project file from your computer or you can drag and drop your file to this window. Please only upload one project at a time. Allowed file types: zip (preferred), aiff, aif, wav. Click 'Submit' to begin the file upload and submit the form.</p>								 <span class="btn btn-success fileinput-button">
