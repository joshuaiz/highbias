...
function bones_custom_admin_footer() {
	_e('<span id="footer-thankyou">Developed by Joshua Michaels for <a href="http://highbiasmastering.com" target="_blank">High Bias Mastering</a></span>. Built using <a href="http://themble.com/bones" target="_blank">Bones</a>.', 'bonestheme');
}
